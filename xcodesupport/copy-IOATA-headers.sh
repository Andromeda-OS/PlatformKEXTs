...
for FILE in IOPCIATA.h IOATABusCommand.h IOATABusInfo.h IOATACommand.h IOATAController.h IOATADevConfig.h IOATADevice.h IOATATypes.h ATADeviceNub.h ATATimerEventSource.h IOATARegI386.h; do
