...
public:
    ...
    virtual IOReturn prepare(IODirection forDirection = kIODirectionNone) override;

    virtual IOReturn complete(IODirection forDirection = kIODirectionNone) override;
